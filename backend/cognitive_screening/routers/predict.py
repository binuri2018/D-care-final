...
from cognitive_screening.config import MONGO_DB, MONGO_URI, MODEL_DIR, REPORT_DIR
from cognitive_screening.schemas import PredictRequest
from cognitive_screening.services.inference import run_full_assessment
...
def health() -> dict[str, str]:
    models_ok = os.path.exists(os.path.join(MODEL_DIR, "medical_regressor.joblib"))
    return {
        "status": "ok",
