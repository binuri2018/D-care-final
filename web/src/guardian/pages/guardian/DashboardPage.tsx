      ...
      <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2}>
        <Card sx={{ flex: 1 }}>
          <CardContent>
            ...
            <Button variant="contained" fullWidth onClick={() => navigate('mri')}>
              Open
            </Button>
          </CardContent>
        </Card>
        <Card sx={{ flex: 1 }}>
          <CardContent>
            ...
            <Button variant="contained" color="secondary" fullWidth onClick={() => navigate('clinical')}>
              Open
            </Button>
          </CardContent>
        </Card>
        <Card sx={{ flex: 1 }}>
          <CardContent>
            ...
            <Button variant="outlined" fullWidth onClick={() => navigate('pairing')}>
              Open
            </Button>
          </CardContent>
        </Card>
