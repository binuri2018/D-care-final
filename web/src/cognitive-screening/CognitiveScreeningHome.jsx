...
export default function CognitiveScreeningHome() {
  const startAdaptive = () => {
      ...
      <div className="hero">
        ...
        <details style={{ marginTop: "1rem" }}>
          ...
          <div style={{ marginTop: "0.6rem" }}>
            <Link className="btn btn-ghost" to="/screening/patient" onClick={startLegacy}>
              Start legacy MMSE
            </Link>
          </div>
        </details>
        ...
        <p style={{ marginTop: "1.2rem" }}>
          <Link className="btn btn-ghost" to="/screening/results">
